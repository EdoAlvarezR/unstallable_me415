...
sc=0.0001
targetlats=[40.267198,40.267638,40.267738,40.26752]
targetlogs=[-111.635642,-111.635170,-111.635670,-111.635870]
...
#plt.legend()
plt.scatter(targetlats,targetlogs,color='r')
plt.scatter(40.267198,-111.635642,color='k')
#Estimate of 10 m radius
for j in range(0,len(targetlats)):
    circ=plt.Circle((targetlats[j],targetlogs[j]),0.00012,fill=False,color='r',linestyle='--')
    ax1.add_patch(circ)
plt.show()
print 'Done'
