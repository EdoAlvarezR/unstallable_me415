...
# Wing
b_w = 600*2/1000        # (m) span
lambda_w = 20*pi/180        # (rad) sweep
...
Mtot = (300 + 306 + 68)/1000 # Fuselage (no payload) + Wing_and_canard + Canard_weight
